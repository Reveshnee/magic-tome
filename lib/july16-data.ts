...
export const CLIENTS: Client[] = [
  ...
  },
  {
    ...
    update:
      'Two proposal revisions sent to Ranjith (9 Jul). PRASA RFQ closes Friday 17 July — Praveen has not responded as at today. Genuine risk of missing the close.',
    nextActions: ['URGENT: Chase Praveen before Fri 17 Jul close'],
    venuActions: ['Escalation support if no response by tomorrow morning'],
    owner: 'Reveshnee',
    urgency: 'critical',
  },
  {
  ...
  },
  {
    ...
    update:
      'Fully resolved. CR sheet and commercials finalised, Venu sign-off completed 5 Jul. Quotation sent to Moeen 3 Jul; awaiting his response now.',
    nextActions: ['Monitor Moeen response to quotation'],
    venuActions: ['Decision: chase Moeen directly, or park it?'],
    owner: 'Reveshnee',
    urgency: 'normal',
  },
  {
  ...
  },
  {
    ...
    nextActions: ['No action; standard process'],
    venuActions: [],
    owner: 'Reveshnee',
    urgency: 'none',
  },
  {
    id: 12,
    name: 'Irdeto',
    engagement: 'SF Support + Platform POC',
    health: 'On Track',
    contacts: 'Corne / Detleena',
    update: "Ongoing SF support continues. Om/Detleena scoping call still to be arranged.",
    nextActions: ['Schedule Om/Detleena call'],
    venuActions: ["Confirm Om's scoping authority"],
    owner: 'Venu / Om',
    urgency: 'normal',
  },
  {
...
export const PROPOSALS: Proposal[] = [
  ...
  { client: 'BCX/Nedbank', opportunity: 'PRASA RFQ (subcontractor)', value: 'TBC', stage: 'Submitted', nextAction: 'Closes Fri 17 Jul. Awaiting Praveen response.', owner: 'Reveshnee' },
